...
for i in range(1,2):
    prefix = "full_3D_dadi_job_{}".format(i)
    Optimize_Functions.Optimize_Routine(fs, pts, prefix, "sim_split_refugia_sym_mig_all", sim_split_refugia_sym_mig_all, 3, 8,  param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
