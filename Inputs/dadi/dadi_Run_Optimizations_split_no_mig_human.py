...
def split_no_mig_human(params, ns, pts):
    """
    Model with split between pop 1 and (2,3), then split between 2 and 3.
...
for i in range(1,2):
    prefix = "full_3D_dadi_job_{}".format(i)
    Optimize_Functions.Optimize_Routine(fs, pts, prefix, "split_no_mig_human", split_no_mig_human, 3, 10,  param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
...
#pts = [50,60,70]
#p_labels = "nu1, nuA, nu2, nu3, mA, m1, m2, m3, T1a, T1b, T2, T3"
#upper = [20,20,20,20,20,20,20,20,15,15,15,15]
#lower = [0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.1,0.1,0.1,0.1]
#reps = [10,20,50]
#maxiters = [5,10,20]
#folds = [3,2,1]
...
#for i in range(1,2):
#    prefix = "full_3D_dadi_job_{}".format(i)
#    Optimize_Functions.Optimize_Routine(fs, pts, prefix, "refugia_sym_mig_all_no_mig", refugia_sym_mig_all_no_mig, 3, 12,  param_labels = p_labels, in_upper=upper, in_lower=lower, reps = reps, maxiters = maxiters, folds = folds)
